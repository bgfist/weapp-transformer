...
export function transformTemplate(source) {
	...
	return $.html({ decodeEntities: false, selfClosingTags: true });
}
...
export function transformWxml() {
	return globExt('wxml')
		.pipe(through2.obj(function (file, enc, callback) {
			...
			file.contents = Buffer.from(transformTemplate(String(file.contents)));
			this.push(file);
